const state = reactive({
    ...
    betsHelperFilters: ['Last 5 games', 'H2H', 'Facts']
});
...
const getBetsHelperFilters = () => state.betsHelperFilters;
...
const setSelectedBetsHelperFilter = (response) => (state.selectedBetsHelperFilter = response);
const setLiveToggle = (response) => (state.liveToggle = response);

//GetGlobal
const getSelectedTab = () => state.selectedTab;
const getSelectedBetsHelperFilter = () => state.selectedBetsHelperFilter;
...
export default {
    ...
    getStandings,
    setStandings,
    setSelectedBetsHelperFilter,
    getSelectedBetsHelperFilter,
    getBetsHelper,
    setBetsHelper,
    setTeamsFromStandings,
    getTeamsFromStandings,
    getFixtureTabs,
    getBetsHelperFilters
};
